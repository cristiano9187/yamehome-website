...
import { X, CreditCard, Smartphone, Banknote, ShieldCheck, Clock, Info, CheckCircle2, Globe, Landmark } from 'lucide-react';
...
const TermsModal: React.FC<TermsModalProps> = ({ onClose, city = 'YAOUNDE' }) => {
  // Mobile Money affiché uniquement pour Bangangté (Yaoundé : voir blocs « moyens officiels »)
  const bangangteMobile = {
              ...
              {city === 'YAOUNDE' ? (
                <>
                  <div className="md:col-span-2 mb-1">
                    <h5 className="text-primary font-bold text-sm uppercase tracking-wide">Moyens de paiement officiels</h5>
                  </div>

                  <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                    <div className="flex items-start gap-3">
                      <div className="w-11 h-11 rounded-lg bg-orange-500 text-white font-black text-xs flex items-center justify-center flex-shrink-0 tracking-tight">
                        OM
                      </div>
                      <div className="min-w-0">
                        <p className="font-bold text-slate-900">Orange Money</p>
                        <p className="text-sm text-slate-600 mt-1">
                          Code marchand <span className="font-mono font-bold text-slate-900">1002038</span> — <span className="font-bold text-slate-800">YAMEHOME</span>
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                    <div className="flex items-start gap-3">
                      <div className="w-11 h-11 rounded-lg bg-yellow-400 text-slate-900 font-black text-[10px] flex items-center justify-center flex-shrink-0 leading-tight text-center px-0.5">
                        MoMo
                      </div>
                      <div className="min-w-0">
                        <p className="font-bold text-slate-900">MTN Mobile Money</p>
                        <p className="text-sm text-slate-600 mt-1 font-bold">YAMEHOME</p>
                        <p className="text-xs text-slate-500 mt-2 italic">Numéro marchand MTN sera communiqué sous peu.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                    <div className="flex items-start gap-3">
                      <div className="w-11 h-11 rounded-lg bg-blue-600 text-white flex items-center justify-center flex-shrink-0">
                        <Landmark size={22} strokeWidth={2} />
                      </div>
                      <div className="min-w-0">
                        <p className="font-bold text-slate-900">RIB bancaire ou PayPal</p>
                        <p className="text-sm text-slate-600 mt-1">Coordonnées communiquées sur demande.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                    <div className="flex items-start gap-3">
                      <div className="w-11 h-11 rounded-lg bg-emerald-600 text-white flex items-center justify-center flex-shrink-0">
                        <Banknote size={22} strokeWidth={2} />
                      </div>
                      <div className="min-w-0">
                        <p className="font-bold text-slate-900">Espèces</p>
                        <p className="text-sm text-slate-600 mt-1">Espèces sur place.</p>
                      </div>
                    </div>
                  </div>

                  <div className="bg-slate-800 p-4 rounded-xl text-white shadow-lg flex flex-col justify-center md:col-span-2">
                ...
                <>
                  ...
                  <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                    <div className="flex items-center gap-2 mb-3 text-primary">
                      ...
                      <span className="font-bold text-sm uppercase">Mobile Money (Bangangté)</span>
                    </div>
                    <div className="space-y-3">
                      <div className="flex items-center justify-between p-2.5 rounded-lg bg-orange-50 border border-orange-100">
                        ...
                        <span className="text-base font-mono font-bold text-slate-900">{bangangteMobile.orange}</span>
                      </div>
                      <div className="flex items-center justify-between p-2.5 rounded-lg bg-yellow-50 border border-yellow-100">
                        ...
                        <span className="text-base font-mono font-bold text-slate-900">{bangangteMobile.mtn}</span>
                      </div>
                      <p className="text-[10px] text-slate-500 font-bold px-1 uppercase leading-tight">Au nom de : <span className="text-slate-900">{bangangteMobile.name}</span></p>
                    </div>
                  </div>
